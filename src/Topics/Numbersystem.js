...
import percentageData from '../Questions/numbersystem.json';
...
const chapterName = "Number System"
const pageValue="number-system"
...
<Helmet>
      ...
      <meta name="description" content={'Practice Number System Questions For Placements and Other Competitive Examinations.'}/>
      <meta name="keywords"content="Aptitude Questions, Placements preparation, Number System Placements Questions, UPSC Quadratic Equations Questions."/>
...
<div class="flex flex-wrap mt-4 mx-2 mb-8">
      ...
      <div class="containerelement">
        ...
        <section class="relative py-16 bg-white min-w-screen animation-fade animation-delay">
          ...
          <div key={question.id} class="mt-16">
            <div class="quiz-container">
        <div class="question-numbercontainer"> 
        <p class="text-sm text-gray-300">{value}<br/> Chapter: {chapterName} </p>                
        </div>                
