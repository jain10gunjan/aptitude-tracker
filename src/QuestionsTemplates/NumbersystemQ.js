...
const NumbersystemQ = () => {
  ...
  const pageValue = '/number-system/questions/'
    ...
    <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
      ...
      <div>
          ...
          <p class="text-sm text-gray-300">Aptitude Questions <br/>Chapter : Number System </p>                
          </div>                
